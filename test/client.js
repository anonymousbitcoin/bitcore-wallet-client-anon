...
helpers.toSatoshi = function(anon) {
  if (_.isArray(anon)) {
    return _.map(anon, helpers.toSatoshi);
  } else {
    return parseFloat((anon * 1e8).toPrecision(12));
  }
};
...
describe('client API', function() {
  ...
  describe('Build & sign txs', function() {
    ...
    describe('#signTxp', function() {
      ...
      it('should sign anon proposal correctly', function() {
        var toAddress = 'msj42CCGruhRsFrGATiUuh25dtxYtnpbTx';
        var changeAddress = 'msj42CCGruhRsFrGATiUuh25dtxYtnpbTx';
  ...
  describe('Network fees', function() {
    it('should get current fee levels for ANON', function(done) {
      ...
      clients[0].credentials = {};
      clients[0].getFeeLevels('anon', 'livenet', function(err, levels) {
        should.not.exist(err);
        should.exist(levels);
  ...
  describe('Transaction Proposal signing', function() {
    ...
    describe('ANON', function(done) {
      beforeEach(function(done) {
        setup(2, 3, 'anon', 'testnet', done);
      });
  ...
  var addrMap = {
    anon: ['1PuKMvRFfwbLXyEPXZzkGi111gMUCs6uE3','1GG3JQikGC7wxstyavUBDoCJ66bWLLENZC']
  };
  _.each(['anon'], function(coin) {
